...
export default {
   ...
   * 산은 **위아래로도 갈라진다.**
   *
   * 냇가 직전의 지면 틈(1860~1960)으로 **내려가면** 물가 바위가 있다. 냇물(2210~3110)
   * 보다 왼쪽이라 안전하고, 주운 뒤 86px 를 다시 뛰어올라야 길로 돌아온다.
   * 능선(6180) 에서는 위로 두 단 더 올라가 나뭇가지에 닿는다. 낙석이 지나는 자리라
   * 위험을 뚫고 가는 대가가 있다.
   */
  ledges: [
    { x: 640, y: 660, w: 110 },
  ...
  keepsakes: [
    { id: 's3_streamrock', x: 1915, y: 552 },
    { id: 's3_branch', x: 6266, y: 134 },
  ],
